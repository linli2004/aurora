...
QtObject {
    ...
    function text(key) {
        ...
        case "music.sourceHint": return "貼上音訊 URL、HLS m3u8，或 M3U 內容"
        case "music.sourceHelp": return "支援合法 http/https 音訊流與本地 M3U 播放列表"
    ...
    function englishText(key) {
        ...
        case "music.sourceHint": return "Paste audio URL, HLS m3u8, or M3U content"
        case "music.sourceHelp": return "Supports legal http/https audio streams and local M3U playlists"
